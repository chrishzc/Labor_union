...
_STAGE_META: tuple[tuple[int, CoreStageCode, str], ...] = (
    ...
    (6, "external_signing_dispatch", "建立契約並送交外部簽署平台"),
    (7, "external_signing_completion", "雙方外部簽署完成"),
    (8, "deposit_settlement", "客戶定金核銷"),
...
_SUBSTATUS_BY_CODE: Mapping[CoreStageCode, Mapping[StageStatus, str]] = {
    ...
    "external_signing_dispatch": {
        "not_started": "external_dispatch_pending",
        "in_progress": "external_dispatch_preparing",
        "blocked": "external_dispatch_blocked",
        "completed": "external_dispatch_completed",
        "unavailable": "external_dispatch_unavailable",
    },
    "deposit_settlement": {
    ...
    "external_signing_completion": {
        "not_started": "external_signing_pending",
        "in_progress": "external_signing_in_progress",
        "blocked": "external_signing_blocked",
        "completed": "external_signing_completed",
        "unavailable": "external_signing_unavailable",
    },
    "confirmed_service_dates": {
