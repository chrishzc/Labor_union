...
_ENTRIES = (
    ...
    LineNavigationEntry("開啟待辦工作台", "union_menu", "admin", "/line-mobile-admin?target=staff_review", "line:staff-review"),
    LineNavigationEntry("開啟異常中心", "union_menu", "admin", "/line-mobile-admin?target=anomalies_center", "line:anomalies-center"),
    LineNavigationEntry("開啟營運摘要", "union_menu", "admin", "/line-mobile-admin?target=dashboard", "line:operations-summary"),
    ...
    LineNavigationEntry("服務與問答", "service_help_menu", "navigation", "/line-mobile-admin?target=customer_service", None),
    LineNavigationEntry("常見問答", "service_help_menu", "navigation", "/line-mobile-admin?target=customer_service", None),
    LineNavigationEntry("問答", "service_help_menu", "navigation", "/line-mobile-admin?target=customer_service", None),
    LineNavigationEntry("FAQ", "service_help_menu", "navigation", "/line-mobile-admin?target=customer_service", None),
    LineNavigationEntry("修改訂單資訊", "order_update_menu", "navigation", "/line-order-update", None),
    LineNavigationEntry("修改服務地址", "order_update_request", "navigation", "/line-mobile-admin?target=customer_service", None),
    LineNavigationEntry("修改下廚需求", "order_update_request", "navigation", "/line-mobile-admin?target=customer_service", None),
    LineNavigationEntry("修改服務天數", "order_update_request", "navigation", "/line-mobile-admin?target=customer_service", None),
    LineNavigationEntry("修改每日服務時段", "order_update_request", "navigation", "/line-mobile-admin?target=customer_service", None),
    LineNavigationEntry("其他訂單內容", "order_update_request", "navigation", "/line-mobile-admin?target=customer_service", None),
