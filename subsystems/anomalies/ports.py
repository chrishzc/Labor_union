...
class AnomalyRuntime(Protocol):
    ...
    def project_finance_import_review_alert(self, cursor: Any, batch_id: int, **kwargs: Any) -> dict[str, Any]: ...

    def consume_staff_payables_anomaly_sources(self, connection: Any, **kwargs: Any) -> Any: ...

    def consume_process_reminder_anomaly_sources(self, connection: Any, **kwargs: Any) -> Any: ...

    def project_beclass_import_review_page(self, connection: Any, **kwargs: Any) -> Any: ...

    def project_government_subsidy_anomaly_page(self, connection: Any, request: Any) -> Any: ...

    def project_government_subsidy_assignment_drift_page(self, connection: Any, request: Any) -> Any: ...

    def project_government_subsidy_integrity_page(self, connection: Any, request: Any) -> Any: ...

    def project_government_subsidy_reversal_page(self, connection: Any, request: Any) -> Any: ...

    def project_government_return_outbound_overage_page(self, connection: Any, request: Any) -> Any: ...

    def scheduling_coverage_consumer(self, connection: Any) -> Any: ...
