-- Preserve-data replacement of the Payroll columns in v_order_details.
-- Missing case-owned Payroll terms remain NULL; identity-based rate fallback is forbidden.
