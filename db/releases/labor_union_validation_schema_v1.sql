...
-- BEGIN SOURCE: db/schema_parts/1014_historical_baseline_projector_v2.sql
...
-- BEGIN SOURCE: db/schema_parts/1021_task96_owner_contract_successors.sql
...
-- BEGIN SOURCE: db/schema_parts/215_historical_service_accounting.sql
...
FOR EACH ROW SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'client payment destination receipts are immutable';
-- END SOURCE: db/schema_parts/1029_client_payment_destination_configuration.sql

-- BEGIN SOURCE: db/schema_parts/218_weekly_report_metrics.sql
...
-- END SOURCE: db/schema_parts/218_weekly_report_metrics.sql

-- BEGIN SOURCE: db/schema_parts/1032_matching_holiday_work_agreements.sql
...
-- BEGIN SOURCE: db/schema_parts/222_matching_plan_create_receipts.sql
