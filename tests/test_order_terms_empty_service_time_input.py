"""Issue #337: the HTTP input types preserve an explicit empty time tuple."""
import pytest
...
@pytest.mark.parametrize('values', [
    {'start_time': '', 'end_time': '', 'end_day_offset': None},
    {'start_time': '25:00:00', 'end_time': '17:00:00', 'end_day_offset': 0},
    {'start_time': '09:00:00', 'end_time': '17:00:00', 'end_day_offset': 2},
])
def test_invalid_values_are_not_coerced_to_empty(values):
    with pytest.raises(ValidationError):
        OrderTermsInput.model_validate(_payload(values))
