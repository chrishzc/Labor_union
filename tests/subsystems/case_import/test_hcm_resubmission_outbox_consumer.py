"""
File: test_hcm_resubmission_outbox_consumer.py
Description: 驗證 Case Import HCM resubmission outbox consumer 的 canonical identity、fresh-root、claim ordering 與 replay guards。
"""
