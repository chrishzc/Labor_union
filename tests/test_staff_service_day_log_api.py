...
def test_preview_service_day_log_is_read_only_and_returns_typed_blocker(monkeypatch) -> None:
    ...
    response = staff_service_day_logs.preview_service_day_log(StaffServiceDayLogPreviewRequest(assignment_id=71, service_date="2026-08-16", baby_log_text="寶寶已完成日誌"))
