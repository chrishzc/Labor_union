...
def test_architecture_worker_delivers_subsidy_advance_recovery_events(monkeypatch):
    ...
    monkeypatch.setattr(outbox_worker, "consume_historical_order_adoption_review_events", lambda _: _Result(6, 4))
    ...
    assert (result.delivered_count, result.failed_count) == (38, 26)
