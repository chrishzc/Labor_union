...
def test_cancellation_client_carries_preview_versions_and_confirmed_days():
    session = FakeSession([
        ...
        _response({
            "cancellation_date": "2026-08-03", "actual_end_date": "2026-08-02",
            "confirmed_service_days": [{"service_date": "2026-08-02", "staff_id": 7, "reason": None}],
            "official_service_day_count": 1, "official_service_hours": 8,
            "order_version": 2, "scheduling_version": 3,
            "scheduling_generation": 1, "client_finance_version": 4,
            "payroll_version": 5, "scheduling": {}, "client_finance_impact": {},
            "payroll_impact": {}, "lifecycle_impact": {},
