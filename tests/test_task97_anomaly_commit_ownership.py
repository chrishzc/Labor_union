...
SOURCE_MODULES = (
    ...
    "infrastructure/mysql/government_return_outbound_overage_anomaly_source.py",
    "infrastructure/mysql/government_subsidy_anomaly_source.py",
    "infrastructure/mysql/government_subsidy_assignment_drift_anomaly_source.py",
    "infrastructure/mysql/government_subsidy_integrity_anomaly_source.py",
    "infrastructure/mysql/government_subsidy_reversal_anomaly_source.py",
)
...
def test_projection_sources_delegate_uow_and_do_not_commit() -> None:
    for relative_path in SOURCE_MODULES:
        ...
        assert ".begin(" not in source, relative_path
