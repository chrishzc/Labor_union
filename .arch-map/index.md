...
- `anomalies -> external-integration/line` — Anomalies只消費LINE-006 notification-failure typed current-fact readback並維護current projection；LINE仍擁有identity root、projection、version與合法雙角色判讀。
