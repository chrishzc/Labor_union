...
`tests/domains/external-integration/subsystems/access/integration/test_access_session_expiry_policy.py` protects absolute-only session expiry, refresh, revocation and enabled-actor guards.
