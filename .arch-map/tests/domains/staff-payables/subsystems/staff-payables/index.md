...
# Routing notes
Current owner-local coverage includes payout reconciliation workflow/public contracts, payout repository recovery, overpayment recovery, and accounts-payable export source/workflow contracts. PAYOUT/anomaly projection tests belong to the Anomalies verification boundary and are not duplicated here.
