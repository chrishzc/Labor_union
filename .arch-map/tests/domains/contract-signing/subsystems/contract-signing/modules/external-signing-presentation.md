...
# Owned verification
- `ui_react/src/tests/domains/contract-signing/subsystems/contract-signing/modules/external-signing-presentation/contract_external_signing_actions.test.tsx` — closed states、歷史簽回 lineage、Preview invalidation、未知結果不得重送與 final PDF readback。
