...
- Legacy Streamlit tests under flat `tests/` remain deferred to their owning UI retirement rather than being misfiled as current Orders owner-local coverage.
