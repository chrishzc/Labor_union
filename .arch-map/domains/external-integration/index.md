...
- depended_by: `anomalies` — LINE-006 notification-failure recheck consumes the LINE-owned typed current-fact readback；Anomalies does not read LINE private tables or mutate identity roots。
