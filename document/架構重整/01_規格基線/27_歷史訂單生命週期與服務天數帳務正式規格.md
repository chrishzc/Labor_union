...
回推後，工會人員必須在原本的訂單工作台完成日期精算、人工排休調整、正式服務日期確認、正式排班，
以及需要時的實際開工確認。歷史採納已唯一解析的月嫂是此案既定服務人員；重啟後仍由 Scheduling 透過
...
14. 歷史未服務／服務中明確重啟精算成功：回正常訂單成立；來源實際起訖只保留於歷史 evidence／event，Orders
    ...
    重新精算、確認日期、媒合、排班與確認實際開工；既有歷史天數、義務及付款 lineage 保留供差額核對。
...
18. 歷史未服務／服務中成功重啟後，已完成正式服務日期與排班，Actual Start 確認日不晚於 business date，
