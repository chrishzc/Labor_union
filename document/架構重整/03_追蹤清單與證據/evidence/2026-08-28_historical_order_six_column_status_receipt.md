...
| Acceptance | 狀態 | 證據 |
|---|---|---|
| `HOS-A1` 六欄 `0／1／2` exact mapping | passed | `tests/test_wp80_historical_order_adoption.py`、`tests/test_historical_order_workbook_import.py` |
...
.venv/bin/python -m pytest -q \
  tests/test_wp80_historical_order_adoption.py \
