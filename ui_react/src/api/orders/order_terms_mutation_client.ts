...
export const OrderTermsQuerySchema = z.strictObject({
  ...
  client_finance_version: VersionSchema.nullable(),
  payroll_version: VersionSchema.nullable(),
...
export const OrderTermsPreviewSchema = z.strictObject({
  ...
  client_finance_impact: z.record(z.string(), z.unknown()).nullable(),
  payroll_impact: z.record(z.string(), z.unknown()).nullable(),
...
export const OrderTermsApplyPayloadSchema = OrderTermsPreviewPayloadSchema.extend({
  ...
  expected_client_finance_version: VersionSchema.nullable(),
  expected_payroll_version: VersionSchema.nullable(),
  preview_fingerprint: FingerprintSchema,
  requires_formal_apply: z.boolean(),
