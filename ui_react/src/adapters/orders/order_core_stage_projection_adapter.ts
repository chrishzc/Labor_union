...
export const CORE_STAGE_DEFINITIONS: readonly CoreStageDefinition[] = [
  ...
  { ordinal: 6, code: 'external_signing_dispatch', shortLabel: '送外簽', label: '建立契約並送交外部簽署平台', ownerLabel: 'Contract Signing' },
  { ordinal: 7, code: 'external_signing_completion', shortLabel: '簽署完成', label: '雙方外部簽署完成', ownerLabel: 'Contract Signing / Orders' },
  { ordinal: 8, code: 'deposit_settlement', shortLabel: '定金', label: '客戶定金核銷', ownerLabel: 'Client Finance' },
