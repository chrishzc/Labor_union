...
const INFO_FIELDS = {
  1: [
    ...
    ['f_104_c4', '服務開始日'], ['f_105_c5', '服務結束日'], ['f_106_c6', '每日服務小時'],
    ['service_time', '每日服務時段'], ['service_type', '服務方式'], ['f_107_c7', '希望服務天數'],
    ['f_108_c8', '服務地址'], ['baby_info', '寶寶資訊'], ['f_109_c9', '服務單價'],
    ['subsidy_salary', '補助請款金額'], ['subsidy_payment_date', '補助付款日'],
    ['f_110_ca', '服務薪資（現行資料）'], ['f_111_cb', '預計發薪日（現行資料）'],
    ['self_pay_salary', '雇主自費金額'], ['self_pay_payment_date', '自費付款日'],
    ['total_salary', '總薪資'], ['f_112_cc', '樓層費'], ['f_114_ce', '特殊休假日'], ['f_115_cf', '備註'],
  ],
  2: [
    ...
    ['f_217_f1', '胎數與特殊計費'], ['f_218_f2', '服務樓層方式'], ['f_204_e4', '樓層費'],
