...
export const LineManagementPage: React.FC<LineManagementPageProps> = ({
  ...
  return (
    <div className="line-page-wrapper" data-control-id="line.page">
      ...
      {activeTab === 'richmenu' && <LineRichMenuPublicationActions selectedMenu={selectedMenu} selectedPublication={selectedPublication.value} onQueued={() => setRichMenuReload((value) => value + 1)} />}
