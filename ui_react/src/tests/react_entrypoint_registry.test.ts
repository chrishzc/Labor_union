 ...
 * Description: 驗證System Status identity amendment後15個受保護React entry身分。
 */
...
const EXPECTED_HASHES = [
  ...
  'account-management', 'system-status', 'line-ai-events', 'line-liff-studio', 'line-security',
] as const;

describe('React entrypoint registry', () => {
  it('保留 15 個現行管理端 entry，且沒有重複 identity', () => {
