...
describe('常見 QA 題庫 panel', () => {
  ...
  it('從 server QA catalog 顯示題目、狀態與核准答案', async () => {
    ...
    await waitFor(() => expect(screen.getByText(/共 29 筆 · 17 筆可自動回答/)).toBeInTheDocument());
    ...
    fireEvent.change(screen.getByLabelText('回答狀態'), { target: { value: 'missing' } });
