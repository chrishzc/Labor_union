...
function context(action: Record<string, unknown>) {
  ...
  return AnomalyRecoveryContextViewSchema.parse({
    issue_key: `ci_${fingerprint}`,
    definition_code: definitionCode,
    owner_domain: owner,
    owner_root_type: 'owner-root',
    subject: {
      redaction_version: 'anomaly-safe.v1',
      definition_code: definitionCode,
      fields: [],
    },
    owner_snapshot_token: 'owner-snapshot:17',
    owner_version: 3,
    severity: 'blocking',
    blocking: true,
    details_version: 1,
    ...
    episode_started_at: '2026-08-27T10:00:00+08:00',
    last_verified_at: '2026-08-27T10:00:00+08:00',
