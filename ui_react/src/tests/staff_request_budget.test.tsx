...
describe('Staff request budget', () => {
  ...
  it('lifecycle uses one query plus preview/apply/requery', async () => {
    ...
    fireEvent.change(screen.getByLabelText('Lifecycle 生效時間'), { target: { value: '2026-09-01T09:00' } });
    fireEvent.change(screen.getByLabelText('Lifecycle 原因代碼'), { target: { value: 'voluntary_retirement' } });
