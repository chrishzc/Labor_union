...
const SUMMARY = {
  ...
  incomplete_count: 1,
  order_status_counts: {
    '待補件': 0, '洽談中': 0, '訂單成立': 0, '服務中': 1, '訂單完成': 0, '訂單取消': 0,
    '歷史訂單－未服務': 0, '歷史訂單－服務中': 0, '歷史訂單－服務完成': 0, '歷史訂單－帳務完成': 0,
  },
  order_status_missing_count: 1,
};
...
export const WEEKLY_OPERATIONS_REPORT: WeeklyOperationsReport = {
  ...
  annual_totals: [{
    ...
    promotion_count: null, inquiry_count: null, review_rejected_count: 1,
  }],
  monthly_subtotals: [{
    ...SUMMARY, year: 2026, month: 8,
    start_date: '2026-08-20', end_date: '2026-08-26',
    promotion_count: null, inquiry_count: 8, review_rejected_count: 1,
  }],
  data_quality_issues: [
